...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Pusat Pertanyaan - <?=$rest_sistem['result']['meta_title'];?>">
    ...
    <?php } ?>
    <meta property="og:url" content="<?=$main_url;?>faqs">
    
    <?php include "module/include/style.php"; ?>

    <title>Pusat Pertanyaan - <?=$rest_sistem['result']['meta_title'];?></title>
  </head>
  <body>
