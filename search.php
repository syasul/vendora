    ...
    <section class="bg-container-2 mb-5" id="ilistproduk_item">
      <div class="row">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-7 pl-1">
                <div class="mr-3 mt-3">
                  <div class="input-group mb-3">
                    <input type="text" class="form-control border-radius-10 ft-14" id="filter_pencarian_mob" autocomplete="off" placeholder="Cari..." value="<?=$get_param;?>">
          ...
          <div class="border-d border-radius-5">
            ...
            <div class="border-bot-d padding-10-15">
              ...
              <div class="input-group mb-2">
                <input type="text" class="form-control border-radius-10 ft-14" id="filter_pencarian" autocomplete="off" placeholder="Cari..." value="<?=$get_param;?>">
                <div class="input-group-append b-rt-rb-10 border-d">
                  <button class="btn btn-light b-rt-rb-10 ft-14" type="button" onclick="loadMoreData('ref')" style="height: 33px"><span class="icon-search"></span></button>
                </div>
              </div>
            ...
            <div class="border-bot-d padding-10-15">
              ...
              <div class="">
                ...
                <div class="filter-kategori-left-list-k">
                  <a href="<?=$main_url;?>c/<?=$obj['url_kategori'];?>" class="ft-14"><?=$obj['nama_kategori'];?></a>
                  <?php 
                  ...
                  <div class="ml-3">
                    <a href="<?=$main_url;?>c1/<?=$obj['url_kategori'];?>/<?=$objxx['url_kategori'];?>" class="ft-14">
                      <?=$objxx['nama_kategori'];?>
                    </a>
                  </div>
                  <?php } ?>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          <?php 
            $arr = array('tipe' => 'limit', 'price' => '0~0', 'sortby' => '1', 'search' => $get_param, 'start' => '0', 'limit' => '12', 'lang' => 'en');
              ...
              <div class="col-xl-12 col-lg-12">
                <div class="ft-14 color-semidark-m">
                  <div class="float-right_">
                    <div class="w-100">
                      <div class="">
                        Menampilkan <span id="rows_flt-data-appned_produk"><?=$rest_kategori_p['items_count'];?></span> produk untuk pencarian <b>"<?=$get_param;?>"</b> (<b id="rows_post-data-appned_produk">1 - 12</b> of <b id="rows_flt-data-appned_produk_2"><?=$rest_kategori_p['items_count'];?></b>)
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script type="text/javascript">
      ...
      function loadMoreData(a) {
        ...
        $.ajax({
          ...
          timeout: 9000,
          async: true,
          url: '<?=$main_url;?>product_more.php?jen=search_cari&start='+start+'&limit='+limit+'&sortby='+sortby+'&search='+search+'&price='+price,
          beforeSend: function(){
