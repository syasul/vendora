                    ...
                    <table class="table align-items-center table-flush table-hover" id="dataTable">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $checksub = $this->auth->resultData('m_kategori_sub_det a JOIN m_kategori_sub_lv2 b ON a.kategori_sub_lv2_id=b.kategori_sub_lv2_id','a.kategori_sub_id='.$data['kategori_sub_id']);
                            ?>
                            <tr>
                                <td><?=$no;?></td>
                                ...
                                <td align="right">
                                    <a href="javascript:prosesHapus('kategori/hapusSub/<?=$data['kategori_sub_id'];?>');" class="btn btn-danger btn-sm font-size-12"><i class="fa fa-trash"></i></a>
                                    <a href="#" onclick="modalNormal('<?=base_url('kategori/editSub/').$data['kategori_sub_id']?>')" class="btn btn-warning btn-sm font-size-12">Edit</a>
                                </td>
                            </tr>
                            <?php $no++; endforeach; ?>
                        </tbody>
...
<div class="modal fade" id="modalData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="tambahform" action="javascript:prosesDefault('kategori/sub/proses','tambahform')" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                              <label>Warna Text<span style="color: red">*</span></label>
                              <input type="color" class="form-control form-control-color" name="is_color">
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Sub Lv2</label><br>
                      <div class="row">
                        <?php foreach ($all_sub as $sm) : ?>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <label style="margin-bottom: 0px;"><input type="checkbox" name="subrole[]" value="<?=$sm['kategori_sub_lv2_id']?>"> <?=$sm['nama_kategori']?></label><br>
                        </div>
                        <?php endforeach; ?>
                      </div>
                    </div>
...
<div class="modal fade" id="modalDataKpilihan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="tambahformx" action="javascript:prosesDefault('kategori/pilihanSubKategori','tambahformx')" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                      <select class="form-control selectpicker" data-max-options="5" data-live-search="true" multiple="" title="-- Pilih --" name="kategori_sub_id[]" required="">
                        <?php foreach ($all_data as $datarl) : ?>
                        <?php $is = $this->auth->getById('ui_kategori_sub','kategori_sub_id',$datarl['kategori_sub_id']) ?>
                        <option value="<?=$datarl['kategori_sub_id'];?>" <?php if ($is) echo 'selected'; ?>><?=$datarl['nama_kategori'];?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                    <div class="mt-1">
