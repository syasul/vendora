...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="New Products - <?=$rest_sistem['result']['meta_title'];?>">
    ...
    <?php } ?>
    <meta property="og:url" content="<?=$main_url;?>new-arrivals">
    
    <?php include "module/include/style.php"; ?>

    <title>New Products - <?=$rest_sistem['result']['meta_title'];?></title>
  </head>
  <body>
    ...
    <?php 
      $arr = array('wishlist' => 'n', 'idproduk' => 'n', 'new' => 'n', 'tipe' => 'limit', 'start' => '0', 'limit' => '12', 'lang' => 'en');
    ...
    <script type="text/javascript">
      ...
      function loadMoreData(a,b) {
        $.ajax({
          ...
          timeout: 9000,
          async: true,
          url: '<?=$main_url;?>product_more.php?jen=new_products&start='+a+'&limit='+b,
          beforeSend: function(){
            proses = false;
