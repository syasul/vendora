...
<html lang="en">
  <head>
    ...
    <?php } ?>
    <meta property="og:url" content="<?=$main_url;?>c2/<?=$get_param;?>/<?=$get_param2;?>/<?=$get_param3;?>">
  ...
  <body>
    ...
    <section id="carouselCategoryColumn_id" class="bg-container-2 mt-4 mb-30 pb-30-767">
      <div class="title-category pb-3 border-bot-d font-weight-bold ft-18">
        ...
        &nbsp;>&nbsp;
        <a href="<?=$main_url;?>c1/<?=$get_param;?>/<?=$get_param2;?>"><?=$rest_kategori['nama_kategori2'];?></a>
        &nbsp;>&nbsp;
        <?=$rest_kategori['nama_kategori3'];?>
      </div>
    </section>
    ...
    <section class="bg-container-2 mb-5" id="ilistproduk_item">
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          <?php 
            $arr = array('tipe' => 'limit', 'price' => '0~0', 'sortby' => '1', 'search' => '', 'start' => '0', 'limit' => '12', 'idsubkategori' => $rest_kategori['kategori_sub_id'], 'idsubkategorilv2' => $rest_kategori['kategori_sub_lv2_id'], 'lang' => 'en');
                ...
                <div class="ft-14 color-semidark-m">
                  <div class="float-right_">
                    <div class="w-100">
                      ...
                      <div class="">
                        Menampilkan <span id="rows_flt-data-appned_produk"><?=$rest_kategori_p['items_count'];?></span> produk untuk <b>"<?=$rest_kategori['nama_kategori3'];?>"</b> (<b id="rows_post-data-appned_produk">1 - 12</b> of <b id="rows_flt-data-appned_produk_2"><?=$rest_kategori_p['items_count'];?></b>)
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script type="text/javascript">
      ...
      function loadMoreData(a) {
        ...
        $.ajax({
          ...
          timeout: 9000,
          async: true,
          url: '<?=$main_url;?>product_more.php?jen=kategori_c2&k_subid=<?=$rest_kategori['kategori_sub_id'];?>&k_sub2id=<?=$rest_kategori['kategori_sub_lv2_id'];?>&start='+start+'&limit='+limit+'&sortby='+sortby+'&search='+search+'&price='+price,
          beforeSend: function(){
