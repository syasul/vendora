...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Product Digitals - <?=$rest_sistem['result']['meta_title'];?>">
    ...
    <?php } ?>
    <meta property="og:url" content="<?=$main_url;?>product-digitals">
    
    <?php include "module/include/style.php"; ?>

    <title>Product Digitals - <?=$rest_sistem['result']['meta_title'];?></title>
  </head>
  <body>
    ...
    <?php 
      $arr = array('wishlist' => 'n', 'idproduk' => 'n', 'new' => 'd', 'tipe' => 'limit', 'start' => '0', 'limit' => '12', 'lang' => 'en');
          ...
          <div class="row" id="post-data-appned">
            ...
            <?php if (!$nullData) { ?>
              <div class="col-xl-12 col-lg-12">
                <div class="text-center mb-4">Saat ini tidak tersedia.</div>
              </div>
            <?php } ?>
          </div>
          <?php }else{ ?>
    ...
    <script type="text/javascript">
      ...
      function loadMoreData(a,b) {
        $.ajax({
          ...
          timeout: 9000,
          async: true,
          url: '<?=$main_url;?>product_more.php?jen=product_digitals&start='+a+'&limit='+b,
          beforeSend: function(){
            proses = false;
