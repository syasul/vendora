...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Tentang Kami - <?=$rest_sistem['result']['meta_title'];?>">
    ...
    <?php } ?>
    <meta property="og:url" content="<?=$main_url;?>about-us">
    
    <?php include "module/include/style.php"; ?>

    <title>Tentang Kami - <?=$rest_sistem['result']['meta_title'];?></title>
  </head>
  <body>
      ...
      <div class="row justify-content-center mb-30">
        <div class="col-xl-10 col-lg-10 col-md-11">
          <div class="inner-html-cstore">
            <?=$rest_sistem['result']['tentang_kami'];?>
          </div>
        </div>
      </div>
    </section>
