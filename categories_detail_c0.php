...
<html lang="en">
  <head>
    ...
    <?php } ?>
    <meta property="og:url" content="<?=$main_url;?>c0/<?=$get_param;?>">
  ...
  <body>
    ...
    <section id="carouselCategoryColumn_id" class="bg-container-2 mt-4 mb-30 pb-30-767">
      <div class="title-category pb-3 border-bot-d font-weight-bold ft-18">
        <a href="<?=$main_url;?>categories">Semua Kategori</a>
        &nbsp;>&nbsp;
        <?=$rest_kategori['nama_kategori'];?>
      </div>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-5 d-none d-md-block">
          <div class="border-d border-radius-5">
            ...
            <div class="border-bot-d padding-10-15">
              <div class="ft-14 font-weight-bold color-semidark-m mb-2">Kategori</div>
              <?php $arr = array('opsi' => 'i', 'lang' => 'en'); $rest_kategorix = loadData('rest_load/load_kategori/',$arr); ?>
              <div class="">
                <?php foreach($rest_kategorix['result'] as $obj) { ?>
                <div class="filter-kategori-left-list-k">
                  <a href="<?=$main_url;?>c0/<?=$obj['url_kategori'];?>" class="ft-14"><?=$obj['nama_kategori'];?></a>
                </div>
                <?php } ?>
              </div>
            </div>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <?php 
            $arr = array('tipe' => 'limit', 'price' => '0~0', 'sortby' => '1', 'search' => '', 'start' => '0', 'limit' => '12', 'idkategori' => $rest_kategori['kategori_id'], 'lang' => 'en');
            ...
            $arr = array('is' => 'n', 'tipe' => 'limit', 'limit' => '0');
            $rest_bestview_product = loadData('rest_load/load_bestview_product/',$arr);
          ?>
          <div class="mt-2">
            <div class="row">
              <div class="col-xl-12 col-lg-12">
                <div class="ft-14 color-semidark-m">
                  <div class="float-right_">
                    <div class="w-100">
                      <div id="label-data-appned-rekom" class="d-none">
                        Menampilkan <span id=""><?=count($rest_bestview_product['result']);?></span> produk Rekomendasi
                      </div>
                      <div class="">
                        Menampilkan <span id="rows_flt-data-appned_produk"><?=$rest_kategori_p['result'][0]['items_count'];?></span> produk untuk <b>"<?=$rest_kategori['nama_kategori'];?>"</b> (<b id="rows_post-data-appned_produk">1 - 12</b> of <b id="rows_flt-data-appned_produk_2"><?=$rest_kategori_p['result'][0]['items_count'];?></b>)
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-xl-12 col-lg-12">
                <div class="mt-4">
                  ...
                  <div class="row" id="post-data-appned-rekom">
                    <?php foreach($rest_bestview_product['result'] as $objp) : ?>  
                    <div class="<?=$cols_data_infinity;?> mb-4">
                      <div class="default-shadow rounded-2">
                        <a href="<?=$main_url;?>p/<?=$objp['url_produk'];?>">
                          <div class="">
                            ...
                            <?php } ?>
                            <div class="fly-badge-new-arrival-v1" style="top:unset;margin-top: -30px;background:#00b181;">
                              Rekomendasi
                            </div>
                          </div>
    ...
    <script type="text/javascript">
      ...
      function loadMoreData(a) {
        ...
        if(search==''){
          $('#post-data-appned-rekom').removeClass('d-none');
          $('#label-data-appned-rekom').removeClass('d-none');
        }else{
          $('#post-data-appned-rekom').addClass('d-none');
          $('#label-data-appned-rekom').addClass('d-none');
        }
        ...
        $.ajax({
          ...
          timeout: 9000,
          async: true,
          url: '<?=$main_url;?>product_more.php?jen=kategori_c0&k_id=<?=$rest_kategori['kategori_id'];?>&start='+start+'&limit='+limit+'&sortby='+sortby+'&search='+search+'&price='+price,
          beforeSend: function(){
          ...
          success: function(data) {
            ...
            if (res[0]=='' || res[0]=='last') {
              ...
              $('html, body').animate({
                scrollTop: $('#post-data-appned').offset().top-120,
              }, 650);
